...
namespace WalletConfig
{
    ...
    const std::string daemonName = "LGCoind"; //LGCoind

    /* The name to call this wallet */
    const std::string walletName = "zedwallet";

    /* The name of service/walletd, the programmatic rpc interface to a wallet */
    const std::string walletdName = "lgc-service"; //"turtle-service"

    /* The full name of your crypto */
    const std::string coinName = std::string(CryptoNote::CRYPTONOTE_NAME);

    /* Where can your users contact you for support? E.g. discord */
    const std::string contactLink = "https://discord.gg/jgkWVC9"; // http://chat.turtlecoin.lol
